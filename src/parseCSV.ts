...
export async function loadPlayers(): Promise<Player[]> {
  ...
  return lines
    ...
    .map((line) => {
      ...
      // 1:jugador 2:games_played 3:games_starting 4:played_last_game
      // 5-6: lunes  7-9: martes  10-12: miercoles  13-15: jueves
      ...
      return {
        ...
        central: bool(c[30]),
        libero: bool(c[31]),
        games_played: parseInt(c[2] ?? '0', 10) || 0,
        games_starting: parseInt(c[3] ?? '0', 10) || 0,
        played_last_game: bool(c[4]),
      } satisfies Player;
    });
}
